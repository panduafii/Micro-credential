#!/usr/bin/env python3
"""Check data-analyst Q9 and Q10 after fix."""
...
async def check_questions():
    """Check Q9 and Q10 for data-analyst."""
    ...
    try:
        async with engine.begin() as conn:
            ...
            print("\n" + "=" * 60)
            print("DATA-ANALYST PROFILE QUESTIONS Q9-Q10")
            print("=" * 60)
            ...
            for row in questions:
                ...
                if seq == 9:
                    ...
                    if any("jam" in text.lower() for text in option_texts):
